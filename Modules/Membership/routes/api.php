...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    Route::get('membership/pricing-config', [MembershipController::class, 'pricingConfig'])
        ->middleware('role:system_admin,centre_manager,finance_staff');
    Route::put('membership/pricing-config', [MembershipController::class, 'updatePricingConfig'])
